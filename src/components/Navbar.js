...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex justify-between p-1.5"> (Logo will be inserted)
    <div className="text-right">
    <div className="hidden md:block">
      <div className="nav-links flex justify-between p-2">
        <Link to="/">Home</Link>
    ...
    <div className=" md:hidden relative ">
      ...
      {showNav && (
          <div className="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 z-50" onClick={toggleNav}>
      ...
      >
        ...
        <button onClick={toggleNav}>
          <FontAwesomeIcon icon={faTimes} className="text-3xl text-black" />
        </button>
        {/* nav links */}
          <Link to="/">Home</Link>
          <Link to="/aboutus">About Us</Link>
